...
public class ConfigManager {
    ...
    public static YamlConfiguration getDefault(String name) {
        try {
            ...
            LoreAPIPlugin.logSevere("Default config " + name + " was called, but doesn't exist in plugin!");
            return null;
        }
    ...
    public static YamlConfiguration fetchDefaultConfiguration(String name) throws FileNotFoundException {
        InputStream customClassStream = LoreAPIPlugin.getInstance().getClass().getResourceAsStream("/" + name);
